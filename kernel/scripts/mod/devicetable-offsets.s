...
// -mabi=lp64 -mbranch-protection=pac-ret -march=armv8-a
// -auxbase-strip scripts/mod/devicetable-offsets.s -O2 -Wno-psabi -Wall
...
// 0 "" 2
// scripts/mod/devicetable-offsets.c:239: 	DEVID_FIELD(tb_service_id, protocol_revision);
...
// 0 "" 2
// scripts/mod/devicetable-offsets.c:280: 	DEVID(vchiq_device_id);
// 280 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_vchiq_device_id 32 sizeof(struct vchiq_device_id)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:281: 	DEVID_FIELD(vchiq_device_id, name);
// 281 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_vchiq_device_id_name 0 offsetof(struct vchiq_device_id, name)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:283: 	DEVID(coreboot_device_id);
// 283 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_coreboot_device_id 16 sizeof(struct coreboot_device_id)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:284: 	DEVID_FIELD(coreboot_device_id, tag);
// 284 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_coreboot_device_id_tag 0 offsetof(struct coreboot_device_id, tag)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:287: }
#NO_APP
	mov	w0, 0	//,
	ret	
	.size	main, .-main
